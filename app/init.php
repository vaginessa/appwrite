...
App::setResource('schema', function (App $utopia, Redis $cache, Document $project, Database $dbForProject) {
    return SchemaBuilder::buildSchema($utopia, $cache, $dbForProject, $project->getId());
}, ['utopia', 'cache', 'project', 'dbForProject']);
